...
const en = {
    message: {
        ...
        'notifyUserIds': 'Notify users',
        'alertThreshold': 'Alert threshold',
        'statisticWindow': 'Statistic window',
        ...
        'runByParameter': 'Advanced Run',
        'advancedRun': 'Advanced Run',
        'delay': 'Delay(ms)',
        'outerKey': 'Outer Key',
        'extendValue': 'Extend Value',
        'designatedWorkersRuntime': 'Designated Workers',
        'delayPlaceholder': 'Delay execution time in milliseconds',
        'outerKeyPlaceholder': 'For OPENAPI scenario business binding',
        'extendValuePlaceholder': 'For OPENAPI scenario context parameter pass-through',
        'designatedWorkersRuntimePlaceholder': 'Designated workers execution config',
