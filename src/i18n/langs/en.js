...
const en = {
    message: {
        ...
        'nodeAliasName': 'Node alias',
        'nodeParamsName': 'Task parameter',
        'enableName': 'Enable',
        'skipWhenFailedName': 'Allow skips when failed',
        'fullScreen': 'Full Screen',
        'zoomIn': 'Zoom In',
        'zoomOut': 'Zoom out',
        'autoFit': 'Auto Fit',
        'repeatNode': 'Nodes are duplicated and are automatically filtered',
        'saveDAG': 'Save DAG info',
