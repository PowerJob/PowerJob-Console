<template>
  <div>
    ...
    <el-row style="margin-top:-20px">
      <el-col :span="8">
        {{$t('message.status')}}:
        <span class="title">{{this.common.translateInstanceStatus(instanceDetail.status)}}</span>
      </el-col>
      <el-col :span="16">
    ...
    <el-row>
      <el-col :span="24">
        {{$t('message.result')}}:
        <span class="title">{{instanceDetail.result}}</span>
      </el-col>
    </el-row>
    <el-row id="taskDetail">
      {{$t('message.subTaskInfo')}}:
