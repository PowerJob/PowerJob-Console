          ...
          <template slot-scope="scope">
            ...
            <el-dropdown trigger="click">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item>
                  <el-button size="mini" type="text" @click="onClickDeleteJob(scope.row)">{{ $t('message.delete') }}
                  </el-button>
                </el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
      ...
      <el-form :model="modifiedJobForm" label-width="120px">
        ...
        <el-form-item :label="$t('message.scheduleInfo')">
          <el-row>
            ...
            <el-col :span="12">
              <div>
                <input-cron type="text" v-model="modifiedJobForm.timeExpression" :placeholder="$t(modifiedJobForm.timeExpression)"/>
              </div>
            </el-col>
<!--            <el-col :span="4">-->
...
<!--            </el-col>-->
        ...
        <el-form-item :label="$t('message.alarmConfig')">
          <el-select v-model="modifiedJobForm.notifyUserIds" multiple filterable
...
export default {
  name: "JobManager",
  components: {TimeExpressionValidator, InputCron},
  data() {
    return {
      input: "",
      expression: "",
      ...
      dispatchStrategyOptions: [{
        ...
        label: this.$t('message.dps_performance_first')
      }, {key: "RANDOM", label: this.$t('message.dps_random')}],
      // 用户列表
      userList: [],
      // 时间表达式校验窗口
