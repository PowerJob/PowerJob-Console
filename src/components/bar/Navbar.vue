    ...
    <div id="navbar">
        ...
        <div id="right_content">
            ...
            <el-dropdown @command="handleSettings">
                <span class="el-dropdown-link">
                    <p style="color:#ffffff">
                        Settings<i class="el-icon-arrow-down el-icon--right" />
                    </p>
                </span>
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item command="changeAppInfo">{{
                        $t('message.changeAppInfo')
                    }}</el-dropdown-item>
            ...
            <el-dialog :visible.sync="changeAppInfoDialogVisible" width="35%">
                <el-form :model="appInfo" style="margin:0 5px">
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="saveNewAppInfo">{{
                            $t('message.save')
                        }}</el-button>
                        <el-button
                            @click="changeAppInfoDialogVisible = false"
